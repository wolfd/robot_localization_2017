...
class OccupancyField(object):
    """ Stores an occupancy field for an input map.
        An occupancy field returns the distance to the closest
    ...
    def __init__(self, map):
        ...
        # build up a numpy array of the coordinates of each grid cell in the
        # map
        ...
        # build up a numpy array of the coordinates of each occupied grid cell
        # in the map
    ...
    def get_closest_obstacle_distance(self, x, y):
        """ Compute the closest obstacle to the specified (x,y) coordinate in
            the map.  If the (x,y) coordinate is out of the map boundaries,
